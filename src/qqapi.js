...
(function() {
  ...
  module.exports = {
    cookies: cookies,
    long_poll: long_poll,
    get_buddy_list: get_buddy_list,//好友信息
    get_friend_uin2: get_friend_uin2,//具体好友信息
    send_msg_2buddy: send_msg_2buddy,//给好友发信息
    send_msg_2sess: send_msg_2sess,//未知（猜测是群内临时聊天）
    get_group_list: get_group_list,//群信息
    get_group_member: get_group_member,//具体群信息
    send_msg_2group: send_msg_2group,//给群发信息
    get_discuss_list: get_discuss_list,//讨论组
    get_discuss_member: get_discuss_member,//讨论组
    send_msg_2discuss: send_msg_2discuss//讨论组
  };
